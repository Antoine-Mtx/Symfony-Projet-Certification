...
var $addCollectionButton = $('<button type="button" class="add_collection_link">Créer un composant</button>');
...
$(document).ready(function() {
    ...
    var $collection = $("ul#gestionComposants")
    ...
    $(".gestionComposant").each(function(){
